...
IntLike: Annotated[type, "Works like an int for runtime math"] = int | ScoreSource | DataSource
FloatLike: Annotated[type, "Works like an float/double for runtime math"] = float | ScoreSource | DataSource
...
TextComponentLike: Annotated[type, "Works like a text component"] = (
    str
    | dict[str, "TextComponentLike"]
    | list["TextComponentLike"]
    | DataSource
)
